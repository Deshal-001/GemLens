...
List<Gemstone> gemstones = [
  Gemstone(
    ...
    imgPath: 'assets/images/Amethyst.png',
  ...
  Gemstone(
    ...
    origin: 'Thailand',
    shortDescription:
        'A rare gemstone made up of hard vitreous magnesium oxide.',
    longDescription:
    ...
    imgPath: 'assets/images/black_spinel.png',
  ...
  Gemstone(
    ...
    origin: 'Brazil',
    shortDescription:
        'A pale yellow to brownish orange variety of quartz, popular for its color and affordability.',
    longDescription:
        "Citrine, glowing with the warmth of the sun, shines bright with joy, abundance, and transmutative energy. This gemstone is said to carry the power of the sun itself, never needing to cleanse itself of negativity because it is believed to transmute, dissipate, and ground it. Citrine energizes every level of life, cleansing the chakras and opening the intuition. It attracts wealth, prosperity, and success, inspiring one to achieve their goals. In ancient times, it was used as a charm against snake venom and evil thoughts.",
    imgPath: 'assets/images/Citrine.png',
  ...
  Gemstone(
    ...
    spaceGroup: 'Fd3m',
    identificationColor:
        'Colorless, yellow, brown, gray, black, blue, green, orange, pink, purple, red, violet, and combinations thereof',
    ...
    ultravioletFluorescence:
        'Blue, sometimes weak; in longwave and shortwave ultraviolet light',
  ...
  Gemstone(
    ...
    origin: 'Japan',
    shortDescription:
        'A classic gemstone produced within the soft tissue of a living shelled mollusk.',
    longDescription:
        "Pearl, unlike other gemstones, is a maritime marvel that encapsulates the serene beauty of the ocean. Pearls are formed within the shell of certain mollusks as a defense mechanism against potentially threatening irritants. They symbolize wisdom acquired through experience, offering protection and attracting good luck and wealth. They're also known for their calming effects and their ability to balance one's karma. Pearls have adorned the regal and the divine for centuries, symbolizing purity, spiritual transformation, and the sacred feminine.",
    imgPath: 'assets/images/Pearl.png',
    ...
    spaceGroup: 'Pna21',
    identificationColor:
        'White, cream, yellow, orange, pink, blue, green, silver, black, gray, gold, purple, iridescent',
  ...
  Gemstone(
    ...
    origin: 'Egypt',
    shortDescription:
        'A gem-quality olivine known for its striking olive or lime green color.',
    longDescription:
    ...
    imgPath: 'assets/images/Peridot.png',
  ...
  Gemstone(
    ...
    origin: 'Myanmar',
    shortDescription:
        'A precious stone known for its vibrant red color and hardness, second only to diamond.',
    longDescription:
        "Ruby, a talisman of passion, protection, and prosperity, has been revered throughout history for its vibrant red hue. It symbolizes the sun, and its glowing hue suggests an inextinguishable flame within the stone that legends claim would shine through even the thickest clothing and could not be hidden. Rubies have been possessed by emperors and kings throughout the ages as symbols of wealth and success in love.",
    imgPath: 'assets/images/ruby.png',
